...
> **[RECONCILED 2026-05-22 — DECISION=C set]** Closed: companion = **C** (both layers; substrate = A dependency-free, process = B dogfooded). Maintainer-delegated 2026-05-22 («Твоё решение») — see [wave-sequencing-plan.md §5.1](../wave-sequencing-plan.md) + the N7 execution closure [2026-05-22-n7-dogfood-companions.md §9](2026-05-22-n7-dogfood-companions.md). The block below is the **original pre-decision framing**, preserved unrewritten (append-only).
>
