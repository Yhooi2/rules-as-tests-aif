...
>
> **Authoritative for:** niche-stack support strategy — confidence score taxonomy (high/medium/low), framework behavior per confidence tier, `core/supported-stacks.json` registry shape.
