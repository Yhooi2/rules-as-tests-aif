#!/usr/bin/env bash
# setup.d/10-skills.sh — §1 Skills layer.
# S0 row: §1 Skills → L689-713 (original install.sh line numbers pre-react-native).
# Current install.sh lines: ~L689-745 §1 Skills block (rules-as-tests, tool-bootstrapping,
# orchestration skills pipeline/dispatcher/aif-doctor/template-audit, aif-doctor helpers chmod).
#
