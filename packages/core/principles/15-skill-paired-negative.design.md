...
- **Commit B (LANDED):** `15-skill-paired-negative.test.ts` implementing §3 (body-section marker, maintainer-confirmed) + §5 (`EXEMPT_SKILLS` allowlist) + §6 (positive + 4 mutations). SSOT #54 (ADAPT) registered in the same commit.
